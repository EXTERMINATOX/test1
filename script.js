  ...
  if(payM==='bitcoin'||payM==='zcash'){
    ...
    <div class="cbox">
      ...
      <div style="display:flex; gap:10px; justify-content:center; align-items:center; margin:10px 0;">
        <div class="caddr" id="crypto-addr-val" style="margin:0;">${addr}</div>
      ...
      <div class="qrwrap"><img src="${qr}" alt="${sym} QR Code" onclick="openQR('${qr}', event)" style="cursor:zoom-in;" title="${lang==='fr'?'Cliquez pour agrandir':'Click to enlarge'}"></div>
    </div>
